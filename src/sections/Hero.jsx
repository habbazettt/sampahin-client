const Hero = () => {
    return (
        <div className="md:mt-20 container h-screen mx-auto pt-20">
            <div className="flex flex-col-reverse md:flex-row items-center justify-between relative">
                <div className="md:w-1/2">
                    <h1 className="text-3xl text-center md:text-left md:text-6xl font-semibold text-secondary leading-tight">Kenali Jenis Sampahmu untuk <span className="text-primary">Lingkungan yang lebih Bersih!</span></h1>
